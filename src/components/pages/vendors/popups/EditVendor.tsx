...
import { useGetVendorById, useUpdateVendor } from "src/services/vendor.service";
...
const EditVendor = ({ isOpen, toggle, vendorId }: Props) => {
  // STATES
  const [isUploadOpen, setIsUploadOpen] = useState<boolean>(false);

  // QUERIES
  const { data: vendor } = useGetVendorById(vendorId, !!vendorId);
    ...
    <>
      <Modal show={isOpen} onHide={toggle} centered={true} size="xl">
        <Modal.Header>
          ...
          <h3 className="my-2">Edit Vendor</h3>
        </Modal.Header>
