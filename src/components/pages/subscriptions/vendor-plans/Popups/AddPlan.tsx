...
const AddPlan = ({ isOpen, toggle }: Props) => {
  //FORMINK
  const formik = useFormik({
    initialValues: {
      name: Object.keys(PLANS)[0],
      type: PLANS.EXECUTIVE,
      price: 0,
      description: "",
    },
  ...
  //MUTATION
  // const { mutateAsync: addPlan } = useCreatePosterPlan();
            ...
            <Row className="px-3">
              <Col lg={6} className=" py-1 ">
                <Form.Group className="align-items-center">
                  <Form.Label className="col-form-label">Select Plan name</Form.Label>
                  <Form.Control
                    style={{ color: "#000" }}
                    //   size="md"
                    as="select"
